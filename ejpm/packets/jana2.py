...
class Jana2InstallationInstruction(PacketInstallationInstruction):
    ...
    def __init__(self, top_dir, version_tuple=(6, 14, 4)):

        # Fill the common path pattern
        super(Jana2InstallationInstruction, self).__init__("root", top_dir, version_tuple)
